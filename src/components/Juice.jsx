  ...
  const cart= useContext(CartContext);
    ...
    return(
        ...
        <div className=" flex flex-col flex-1 bg-[url('./assets/JUICE.jpg')] bg-cover" >
          ...
          <JuiceItem id="1." name="orange"  price="$40" button="ADD" onClick={addHandler}></JuiceItem>
          <JuiceItem id="2." name="watermelon"  price="$40" button="ADD" onClick={addHandler}></JuiceItem>
          <JuiceItem id="3." name="apple"  price="$40" button="ADD" onClick={addHandler}></JuiceItem>
          <JuiceItem id="4." name="grapes"  price="$40" button="ADD" onClick={addHandler}></JuiceItem>
        </div>
        </>
    )
}
